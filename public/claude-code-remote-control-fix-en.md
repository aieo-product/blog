...
🇯🇵 [日本語版はこちら / Japanese version](https://qiita.com/otani_ai_memo/items/bfb6fba1d31cb08c8b8d)
...
> **Note:** This change may be overwritten when cmux updates. Re-check after updates.
...
> **⚠️ Important:** It's understandable to want to disable telemetry for privacy. However, in the current Claude Code implementation, disabling telemetry also kills feature flag evaluation. If you want to use gated features like remote-control, telemetry must be enabled.
...
![remote-control working in Antigravity](https://raw.githubusercontent.com/aieo-product/blog/main/images/remote-control-fix/antigravity_ss.png)
