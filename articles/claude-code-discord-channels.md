...
emoji: "🤖"
type: "tech"
topics: ["ClaudeCode", "Discord", "MCP", "AI", "リモート開発"]
published: true
---
...
![全体構成図](/images/discord-channels/architecture.png)
...
![セットアップ手順](/images/discord-channels/setup-flow.png)
...
:::message alert
生成された URL は必ず**ブラウザで開いて**ください。Discord アプリ内に貼っても正しく動作しません。
:::
...
![Discord でのペアリング成功](/images/discord-channels/discord-pairing.png)
...
![Discord 経由で使えるツール](/images/discord-channels/tools.png)
